...
type MapMarker = {
  ...
  whatsapp: string;
  email: string;
  is_reception_location: boolean;
  is_where_couple_staying: boolean;
};
...
export const mapMarkers: MapMarker[] = [
  {
    ...
    google_maps_url: "https://goo.gl/maps/6Z3Z1Z2Z2Z2Z2Z2Z2",
    phone: "+1 (473) 444-4129",
    whatsapp: "",
    email: "reservations@coyaba.com",
    is_reception_location: false,
    is_where_couple_staying: true,
  },
  {
    id: 2,
    ...
    whatsapp: "+1 (473) 418-8782",
    email: "reservations@truebluebay.com",
    is_reception_location: true,
    is_where_couple_staying: false,
  },
];
